...
Implemented an OrderWorkflow that orchestrates multiple activities, handles automatic retries, and ensures that process steps are completed even if the service is restarted.
...
You can then execute your native executable with: `./target/order-processing-1.0.0-SNAPSHOT-runner`
...
Send POST : http://localhost:8080/orders/9998/process

![Screenshot from running application](images/workflow.png?raw=true "Screenshot")

![Screenshot from running application](images/workflow-detail.png?raw=true "Screenshot")
